...
const catalogItems: CatalogItem[] = [
  ...
  { id: 2,  name: "los Tacos Lucky Block 300m x10",   priceUsd: 1.20, stock: 0, emoji: "🌮", category: "lucky" },
  { id: 3,  name: "Heart Lucky Blocks x10",           priceUsd: 1.30, stock: 0, emoji: "❤️", category: "lucky" },
  { id: 4,  name: "Quesadilla Crocodila x10",         priceUsd: 1.90, stock: 0, emoji: "🐊", category: "lucky" },
  { id: 5,  name: "Burrito Bandito x10",              priceUsd: 1.90, stock: 0, emoji: "🌯", category: "lucky" },
  { id: 6,  name: "Los Quesadilla x10",               priceUsd: 1.80, stock: 0, emoji: "🧀", category: "lucky" },
  { id: 7,  name: "Chicleteira Bicicleteira x10",     priceUsd: 1.50, stock: 0, emoji: "🚲", category: "lucky" },
  { id: 8,  name: "67 x10",                           priceUsd: 2.50, stock: 0, emoji: "🎯", category: "lucky" },
  { id: 9,  name: "La Grande Combinasion x10",        priceUsd: 2.30, stock: 0, emoji: "✨", category: "lucky" },
  { id: 10, name: "Los Nooo My Hotsportsitos x10",    priceUsd: 2.50, stock: 0, emoji: "🌶️", category: "lucky" },
  { id: 11, name: "Random PACK SAB x10",              priceUsd: 0.50, stock: 0, emoji: "📦", category: "lucky" },
